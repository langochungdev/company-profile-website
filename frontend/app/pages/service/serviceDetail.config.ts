        ...
        basic: {
            ...
            fields: {
                ...
                category: {
                    type: "select",
                    label: "Danh mục",
                    options: ["Camera", "Hạ Tầng Mạng", "WiFi", "Kiểm Soát", "An Toàn", "Viễn Thông"],
                    required: true,
                },
                price: {
                    type: "text",
        ...
        seo: {
            ...
            fields: {
                metaTitle: {
                    ...
                    label: "Meta Title",
                    max: 60,
                    note: "Mặc định dùng tên dịch vụ",
                },
                metaDescription: {
                    type: "textarea",
...
export type ServiceDetailConfig = typeof serviceDetailConfig;
