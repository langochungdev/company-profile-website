        ...
        <div v-else class="array-items">
            <div v-for="(item, index) in items" :key="index" class="array-item">
                ...
                <div class="item-fields">
                    <Field v-for="(subField, subKey) in field.schema" :key="subKey" :field="(subField as any)" :model-value="item[subKey]" @update:model-value="updateItemField(index, subKey as string, $event)" />
                </div>
            </div>
        </div>
...
<style scoped>
@import "../../styles/components/fields/array-field/desktop.css";
</style>
